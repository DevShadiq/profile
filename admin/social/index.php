							...
							<form action="" method="post" charset="utf-8" data-parsley-validate="" enctype="multipart/form-data">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										...
										<input type="text" class="form-control" id="icon_name" placeholder="Enter Icon Name" name="icon_name" value="<?php if (isset($icon_name)) {
																																							echo $icon_name;
									...
									<div class="form-group col-md-6">
										...
										<input type="text" class="form-control" placeholder="Enter Icon Link" name="icon_link" value="<?php if (isset($icon_link)) {
																																			echo $icon_link;
																																		} ?>" autocomplete>
									</div>
