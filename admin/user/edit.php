								...
								<form action="" method="post" charset="utf-8" data-parsley-validate="" enctype="multipart/form-data">
									<div class="form-row">
										<div class="form-group col-md-6">
											...
											<input type="text" class="form-control" id="u_name" placeholder="Enter name" name="u_name" value="<?php if (isset($edit_row['name'])) {
																																					echo $edit_row['name'];
										...
										<div class="form-group col-md-6">
											...
											<input type="email" class="form-control" id="u_email" placeholder="Enter Email" name="u_email" value="<?php if (isset($edit_row['email'])) {
																																						echo $edit_row['email'];
																																					} ?>" data-parsley-trigger="change" data-parsley-required autocomplete>
										...
										<div class="form-group col-md-6">
											...
											<input type="text" class="form-control" id="u_phone" placeholder="Enter Phone Number" name="u_phone" value="<?php if (isset($edit_row['phone'])) {
																																							echo $edit_row['phone'];
																																						} ?>" data-parsley-trigger="change" data-parsley-required autocomplete data-parsley-length="[11, 15]">
										</div>
										...
										<div class="form-group col-md-6">
											...
											<select class="form-control" name="u_status" data-parsley-required style="font-size:14px;color:#868e96;">
												...
												<option <?php if (isset($edit_row['status']) && $edit_row['status'] == 'active') {
															echo 'selected';
														} ?> value="active" style="font-size:14px;">Active</option>
												<option <?php if (isset($edit_row['status']) && $edit_row['status'] == 'inactive') {
															echo 'selected';
